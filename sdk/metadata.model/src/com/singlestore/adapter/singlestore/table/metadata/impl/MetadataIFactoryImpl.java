...
implements com.singlestore.adapter.singlestore.table.metadata.MetadataIFactory {

    /**
     * The generated Serial Version UID.
     * This is the same as for the 'com.singlestore.adapter.singlestore.table.metadataIPackageImpl'.
     */
    ...
    public <T> T create(com.informatica.imf.icore.IClass iClass) {
        ...
        switch (((com.informatica.imf.icore.internal.ITypeInternal)iClass).getTypeId()) {
     	    case com.singlestore.adapter.singlestore.table.metadata.impl.MetadataIPackageImpl.TABLE_FIELD_EXTENSIONS:
     	        return (T) createTableFieldExtensions(); 
     	    case com.singlestore.adapter.singlestore.table.metadata.impl.MetadataIPackageImpl.TABLE_RECORD_EXTENSIONS:
     ...
     */
     public com.singlestore.adapter.singlestore.table.metadata.TableFieldExtensions createTableFieldExtensions() {
        com.singlestore.adapter.singlestore.table.metadata.TableFieldExtensions tableFieldExtensions = new TableFieldExtensionsImpl();
     ...
     */
     public com.singlestore.adapter.singlestore.table.metadata.TableRecordExtensions createTableRecordExtensions() {
        com.singlestore.adapter.singlestore.table.metadata.TableRecordExtensions tableRecordExtensions = new TableRecordExtensionsImpl();
    ...
    public com.informatica.imf.icore.IPackage getPackage() {
        return com.singlestore.adapter.singlestore.table.metadata.MetadataIPackage.I_INSTANCE;
    }
}