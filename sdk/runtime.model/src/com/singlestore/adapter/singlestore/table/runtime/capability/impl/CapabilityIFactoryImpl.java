...
implements com.singlestore.adapter.singlestore.table.runtime.capability.CapabilityIFactory {

    /**
     * The generated Serial Version UID.
     * This is the same as for the 'com.singlestore.adapter.singlestore.table.runtime.capabilityIPackageImpl'.
     */
    ...
    public <T> T create(com.informatica.imf.icore.IClass iClass) {
        ...
        switch (((com.informatica.imf.icore.internal.ITypeInternal)iClass).getTypeId()) {
     	    case com.singlestore.adapter.singlestore.table.runtime.capability.impl.CapabilityIPackageImpl.TABLE_CALL_CAPABILITY_ATTRIBUTES_EXTENSION:
     	        return (T) createTableCallCapabilityAttributesExtension(); 
     	    case com.singlestore.adapter.singlestore.table.runtime.capability.impl.CapabilityIPackageImpl.TABLE_LOOKUP_CAPABILITY_ATTRIBUTES_EXTENSION:
     	        return (T) createTableLookupCapabilityAttributesExtension(); 
     	    case com.singlestore.adapter.singlestore.table.runtime.capability.impl.CapabilityIPackageImpl.TABLE_READ_CAPABILITY_ATTRIBUTES_EXTENSION:
     	        return (T) createTableReadCapabilityAttributesExtension(); 
     	    case com.singlestore.adapter.singlestore.table.runtime.capability.impl.CapabilityIPackageImpl.TABLE_WRITE_CAPABILITY_ATTRIBUTES_EXTENSION:
     ...
     */
     public com.singlestore.adapter.singlestore.table.runtime.capability.TableCallCapabilityAttributesExtension createTableCallCapabilityAttributesExtension() {
        com.singlestore.adapter.singlestore.table.runtime.capability.TableCallCapabilityAttributesExtension tableCallCapabilityAttributesExtension = new TableCallCapabilityAttributesExtensionImpl();
     ...
     */
     public com.singlestore.adapter.singlestore.table.runtime.capability.TableLookupCapabilityAttributesExtension createTableLookupCapabilityAttributesExtension() {
        com.singlestore.adapter.singlestore.table.runtime.capability.TableLookupCapabilityAttributesExtension tableLookupCapabilityAttributesExtension = new TableLookupCapabilityAttributesExtensionImpl();
     ...
     */
     public com.singlestore.adapter.singlestore.table.runtime.capability.TableReadCapabilityAttributesExtension createTableReadCapabilityAttributesExtension() {
        com.singlestore.adapter.singlestore.table.runtime.capability.TableReadCapabilityAttributesExtension tableReadCapabilityAttributesExtension = new TableReadCapabilityAttributesExtensionImpl();
     ...
     */
     public com.singlestore.adapter.singlestore.table.runtime.capability.TableWriteCapabilityAttributesExtension createTableWriteCapabilityAttributesExtension() {
        com.singlestore.adapter.singlestore.table.runtime.capability.TableWriteCapabilityAttributesExtension tableWriteCapabilityAttributesExtension = new TableWriteCapabilityAttributesExtensionImpl();
    ...
    public com.informatica.imf.icore.IPackage getPackage() {
        return com.singlestore.adapter.singlestore.table.runtime.capability.CapabilityIPackage.I_INSTANCE;
    }
}