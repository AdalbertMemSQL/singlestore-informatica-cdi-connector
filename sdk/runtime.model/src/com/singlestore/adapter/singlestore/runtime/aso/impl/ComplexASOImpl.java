...
/**
 * The implementation for an ComplexASO.
 *
 */
public class ComplexASOImpl
extends com.informatica.adapter.sdkadapter.aso.impl.D_ComplexASOImpl
implements com.singlestore.adapter.singlestore.runtime.aso.ComplexASO {
    /**
     * The generated Serial Version UID.
     */
    private static final long serialVersionUID = 343160497800783961L;
    ...
    /**
     * Default constructor for ComplexASOImpl.
     */
    public ComplexASOImpl() {
        assert iObjInfo != null;
        iSetIClass(com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage.I_INSTANCE
                .getComplexASOIClass());
    }

    /**
     * Constructor for creating proxy object for ComplexASOImpl.
     */
    public ComplexASOImpl(com.informatica.imf.icore.IIdentity identity) {
        assert iObjInfo != null;
        iIsProxy = true;
    ...
    public java.lang.Object iGet(com.informatica.imf.icore.IProperty iProperty) {
    	...
    	if( propertyId <com.informatica.adapter.sdkadapter.aso.impl.AsoIPackageImpl.getD__COMPLEX_A_S_OFeatureCount())
