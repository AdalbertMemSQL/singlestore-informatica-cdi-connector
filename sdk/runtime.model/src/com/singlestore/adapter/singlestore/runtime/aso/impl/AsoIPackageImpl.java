...
implements com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage {
    ...
    private AsoIPackageImpl() {
        super(com.singlestore.adapter.singlestore.runtime.aso.AsoIFactory.I_INSTANCE);
     ...
     */
     public static com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage init() {
       synchronized(com.informatica.imf.icore.IMFRuntime.getInstance().getIMFRegistryLockObject()) {
          LOGGER.log(Level.FINE, "Initialization of com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage: enter 'init()'");
            com.informatica.imf.icore.IMFRuntime imfRuntime = com.informatica.imf.icore.IMFRuntime.getInstance();
          if (imfRuntime.isPackageRegistered(com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage.I_QUALIFIED_NAME)) {
            LOGGER.log(Level.FINE, "Initialization of com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage: already initialized");
            return (com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage)
              imfRuntime.getIPackageForName(com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage.I_QUALIFIED_NAME);
          }

          // Create and register package
          AsoIPackageImpl theComSinglestoreAdapterSinglestoreRuntimeAsoIPackage = (AsoIPackageImpl)
              new com.singlestore.adapter.singlestore.runtime.aso.impl.AsoIPackageImpl();

          theComSinglestoreAdapterSinglestoreRuntimeAsoIPackage.createPackageContents();



          theComSinglestoreAdapterSinglestoreRuntimeAsoIPackage.initializePackageContents();



          imfRuntime.registerPackage(theComSinglestoreAdapterSinglestoreRuntimeAsoIPackage);

          LOGGER.log(Level.FINE, "Initialization of com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage: exit 'init()'");
          return theComSinglestoreAdapterSinglestoreRuntimeAsoIPackage;
      }
    }
    ...
    */
    ...
    public com.informatica.imf.icore.IFactory getFactory() {
       return com.singlestore.adapter.singlestore.runtime.aso.AsoIFactory.I_INSTANCE;
    }
   ...
   private boolean isCreated = false;
    ...
    /**
     ...
     public void createPackageContents() {
         LOGGER.log(Level.FINE, "Initialization of com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage: enter 'createPackageContents()'");
         if (this.isCreated) {
           LOGGER.log(Level.FINE, "Initialization of com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage: already created");
           return;
         }
         this.isCreated = true;
         ...
         LOGGER.log(Level.FINE, "Initialization of com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage: exit 'createPackageContents()'");
    }
  private boolean isInitialized = false;
    ...
    public void initializePackageContents() {
        LOGGER.log(Level.FINE, "Initialization of com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage: enter 'initializePackageContents()'");
      ...
      iSetIdentity(getQualifiedName());
        ...
        initClasses();
        setFactory(com.singlestore.adapter.singlestore.runtime.aso.AsoIFactory.I_INSTANCE);
        ...
        LOGGER.log(Level.FINE, "Initialization of com.singlestore.adapter.singlestore.runtime.aso.AsoIPackage: exit 'initializePackageContents()'");
    }
