@echo off
REM SingleStore connector - client install script
...
for /F %%X in ('dir "%INFA_CLIENT_HOME%/DeveloperClient/configuration" /b /ad') do rmdir  /S /Q "%INFA_CLIENT_HOME%/DeveloperClient/configuration/"%%X
