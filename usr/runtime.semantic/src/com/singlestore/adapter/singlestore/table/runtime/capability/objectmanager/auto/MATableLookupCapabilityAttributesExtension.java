...
package com.singlestore.adapter.singlestore.table.runtime.capability.objectmanager.auto;
...
import com.singlestore.adapter.singlestore.table.runtime.capability.semantic.auto.SATableLookupCapabilityAttributesExtension;
...
public class MATableLookupCapabilityAttributesExtension extends MD_ModelExtensionLookupCapAttributes implements OM_Obj
{
    ...
    public boolean validateAll(boolean recurse, ObjectManagerContext ctx, MetadataObject currentObj, MetadataObject containerObj) throws SL_ValidationException
    {
        ...
        if(!super.validateAll(recurse, ctx, currentObj, containerObj))
            rc = false;
        SATableLookupCapabilityAttributesExtension semObj = (SATableLookupCapabilityAttributesExtension)currentObj;
