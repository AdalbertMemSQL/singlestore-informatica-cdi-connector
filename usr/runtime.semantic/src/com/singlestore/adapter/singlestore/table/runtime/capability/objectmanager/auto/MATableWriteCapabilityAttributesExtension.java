...
import com.singlestore.adapter.singlestore.table.runtime.capability.semantic.auto.SATableWriteCapabilityAttributesExtension;
...
public class MATableWriteCapabilityAttributesExtension extends MD_ModelExtensionWriteCapAttributes implements OM_Obj
{
    ...
    public boolean validate_UpdateMode(ObjectManagerContext ctx, String newVal, MetadataObject semanticObject) throws SL_ValidationException
    {
        ...
        if(newVal.length()<0 || newVal.length()>4000)
            rc = Utils.processLengthViolation((SL_Obj)semanticObject, newVal.length(), 0, 4000, newVal, com.singlestore.adapter.singlestore.table.runtime.capability.TableWriteCapabilityAttributesExtension.Properties.UPDATE_MODE);
        return rc;
