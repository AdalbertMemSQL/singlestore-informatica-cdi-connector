...
public class SingleStoreBaseConnectInfoAdapter extends AbstractINFASDKAdapter  {
    ...
    public SingleStoreBaseConnectInfoAdapter(){
        adpInfo = new SDKAdapterInfo();
        adpInfo.setAdapterType(SDKAdapterTypeEnum.ENTERPRISE_APP);
        adpInfo.setResourceBundleName("i18n/SINGLESTOREBundle");
        adpInfo.setConnectionTypeDesc("SingleStore");
        adpInfo.setConnectionDisplayName("SingleStore");
    ...
    public void updateConnectInfoAttributeTypes(SDKConnectAttributeType attrib){
        ...
        if (attribName.equalsIgnoreCase("hostname")) {
            attrib.setAttributeCLIDisplayName("hostname");
        }
        else
        ...
        if (attribName.equalsIgnoreCase("useSsl")) {
            attrib.setAttributeCLIDisplayName("useSsl");
        }
        else
        if (attribName.equalsIgnoreCase("serverSslCert")) {
            attrib.setAttributeCLIDisplayName("serverSslCert");
        }
        else
        if (attribName.equalsIgnoreCase("keyStore")) {
            attrib.setAttributeCLIDisplayName("keyStore");
        }
        else
        if (attribName.equalsIgnoreCase("keyStorePassword")) {
            attrib.setAttributeCLIDisplayName("keyStorePassword");
        }
        else
        if (attribName.equalsIgnoreCase("keyPassword")) {
            attrib.setAttributeCLIDisplayName("keyPassword");
        }
        else
        if (attribName.equalsIgnoreCase("trustStore")) {
            attrib.setAttributeCLIDisplayName("trustStore");
        }
        else
        if (attribName.equalsIgnoreCase("trustStorePassword")) {
            attrib.setAttributeCLIDisplayName("trustStorePassword");
        }
        else
        if (attribName.equalsIgnoreCase("trustServerCertificate")) {
            attrib.setAttributeCLIDisplayName("trustServerCertificate");
        }
        else
        if (attribName.equalsIgnoreCase("disableSslHostnameVerification")) {
            attrib.setAttributeCLIDisplayName("disableSslHostnameVerification");
        }
    ...
    private SDKConnectionConsumerPage createPage1DFLT(){
    	...
    	presentationPage.getConnInfoConsumerGroups().add(createPage1Group2DFLT());
    ...
    private SDKConnectionConsumerGroup createPage1Group1DFLT(){
        ...
        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("hostname", "HOSTNAME", "HOSTNAME_TOOLTIP",
                	                            true, false, true));
    ...
    private SDKConnectionConsumerGroup createPage1Group2DFLT(){
    	SDKConnectionConsumerGroup group = new SDKConnectionConsumerGroup();

    	group.setGroupName("PAGE_1_GROUP_2_NAME");
    	group.setGroupTitle("PAGE_1_GROUP_2_TITLE");
    	group.setGroupTooltip("PAGE_1_GROUP_2_TOOLTIP");

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("useSsl", "USESSL", "USESSL_TOOLTIP",
                	                            true, true, false));

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("serverSslCert", "SERVERSSLCERT", "SERVERSSLCERT_TOOLTIP",
                	                            true, false, false));

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("keyStore", "KEYSTORE", "KEYSTORE_TOOLTIP",
                	                            true, false, false));

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("keyStorePassword", "KEYSTOREPASSWORD", "KEYSTOREPASSWORD_TOOLTIP",
                	                            true, false, false));

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("keyPassword", "KEYPASSWORD", "KEYPASSWORD_TOOLTIP",
                	                            true, false, false));

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("trustStore", "TRUSTSTORE", "TRUSTSTORE_TOOLTIP",
                	                            true, false, false));

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("trustStorePassword", "TRUSTSTOREPASSWORD", "TRUSTSTOREPASSWORD_TOOLTIP",
                	                            true, false, false));

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("trustServerCertificate", "TRUSTSERVERCERTIFICATE", "TRUSTSERVERCERTIFICATE_TOOLTIP",
                	                            true, false, false));

        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("disableSslHostnameVerification", "DISABLESSLHOSTNAMEVERIFICATION", "DISABLESSLHOSTNAMEVERIFICATION_TOOLTIP",
                	                            true, false, false));
